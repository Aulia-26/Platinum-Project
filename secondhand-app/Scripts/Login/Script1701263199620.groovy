...
WebUI.callTestCase(findTestCase('Verify Login Page'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('null'), GlobalVariable.userEmail)

WebUI.sendKeys(findTestObject('null'), GlobalVariable.userPass)
