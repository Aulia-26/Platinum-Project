...
WebUI.callTestCase(findTestCase('Pages/User Register/Input password'), [('password') : 'pas1'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/User Register/Input email'), [('email') : 'emailcoba'], FailureHandling.STOP_ON_FAILURE)
