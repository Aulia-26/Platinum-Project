...
WebUI.callTestCase(findTestCase('Pages/User Login/Input email'), [('email') : GlobalVariable.rizka_valid_email], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementNotPresent(findTestObject('Homepage/btn_Masuk'), 10)

WebUI.waitForElementClickable(findTestObject('Homepage/icon_profile'), 5)
