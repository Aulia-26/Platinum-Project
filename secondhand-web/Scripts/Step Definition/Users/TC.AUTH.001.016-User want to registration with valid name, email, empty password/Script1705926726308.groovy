...
WebUI.callTestCase(findTestCase('Test Templates/Registration/Registration-Master'), [('uname') : getRandomName(), ('uemail') : generateRandomEmail()
        , ('upassword') : ''], FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementAttributeValue(findTestObject('Registration/input_Password_userpassword'), 'required', 'true', 0)
