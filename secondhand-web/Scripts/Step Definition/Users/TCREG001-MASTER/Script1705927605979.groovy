...
WebUI.callTestCase(findTestCase('Test Templates/Registration/Registration-Master'), [('uname') : GlobalVariable.userName, ('uemail') : GlobalVariable.random_email
        , ('upassword') : GlobalVariable.userPass], FailureHandling.STOP_ON_FAILURE)
