...
WebUI.callTestCase(findTestCase('Pages/ProductOffer/Click button kirim penawaran'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Validation/Offer/Verify success offer'), [:], FailureHandling.STOP_ON_FAILURE)
